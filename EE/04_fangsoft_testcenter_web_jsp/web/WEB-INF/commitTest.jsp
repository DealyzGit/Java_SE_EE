...
<%
    ...
    if (session1.getAttribute(Constants.SESSION_TEST_RESERVATION) != null) {
        trId = (int) session1.getAttribute(Constants.SESSION_TEST_RESERVATION);
    }
    ...
    request.getRequestDispatcher("/" + URLConfig.urlTestResult.replace("{testResultId}",String.valueOf(testResult.getTest().getId()))).
