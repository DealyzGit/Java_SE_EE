...
<form action="j_security_check" class="modal-content animate" method="get" name="loginForm">
    <div class="container">
        <label><b>用户名：</b></label>
        <input name="j_username" type="text" id="userId" value="${cookie.cookie_userId.value}"/>

        <label><b>密码：</b></label>
        <input name="j_password" placeholder="输入密码" required type="password">
