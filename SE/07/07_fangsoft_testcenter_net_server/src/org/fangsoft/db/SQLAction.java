...
public class SQLAction {
    ...
    public int[] batch(Connection conn, String sql, List<Object[]> paramList)
        ...
        try {
            ...
            if (count != 0) rows = stmt.executeBatch();
        } catch (SQLException e) {
            throw e;
        } finally {
            SQLUtil.close(stmt);
    ...
    public <T, P extends IRS2Object<T>> T query2Object(Connection conn,P rsProcessor, String sql, Object... params) throws SQLException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        T result = null;
        try {
            ...
            fillSQLParameter(stmt, params);
            rs = stmt.executeQuery();
            if (rs.next()) result = rsProcessor.process(rs);
        } catch (SQLException e) {
            throw e;
        } finally {
            SQLUtil.close(rs);
    ...
    public <T, P extends IRS2Object<T>> T query2Object(P rsProcessor, String sql, Object... params)
            throws SQLException {
        Connection conn = this.getConnection();
        try {
    ...
    public <T, P extends IRS2Object<T>> List<T> query2List(Connection conn, P rsProcessor, String sql, Object... params)
            throws SQLException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    public <T, P extends IRS2Object<T>> List<T> query2List(P rsProcessor,String sql, Object... params)
            throws SQLException {
        Connection conn = this.getConnection();
        try {
